...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    if(chainIdDec == "56") {
      ...
      const SwapContract2 = new web3.eth.Contract(IndexSwap2.abi, "0x6de0b79ec316BF70fbA203436650Fc7d8739b1E0");
  ...
  approveDeFiTokens = async() => {
    const web3 = new Web3(window.ethereum);  
    const contractAddress = "0x6de0b79ec316BF70fbA203436650Fc7d8739b1E0";
  ...
  withdrawDeFi = async () => {
    ...
    await this.state.SwapContract2.methods.approve("0x6de0b79ec316BF70fbA203436650Fc7d8739b1E0", "115792089237316195423570985008687907853269984665640564039457584007913129639935")
    .send({from: this.state.account});
